...
!= "start")
FAIL()
<< "expected state to be walking";
auto err = machine.FireEvent("walk");
if (err)
FAIL()
<< "transition is expected no error";
}
...
if (!err || !
std::dynamic_pointer_cast<fsm::InvalidEventError>(err
.
value()
))
FAIL()
<< "expected 'InvalidEventError' with correct state and event";
}
...
if (!err || !
std::dynamic_pointer_cast<fsm::UnknownEventError>(err
.
value()
))
FAIL()
<< "expected 'UnknownEventError' with correct event";
}
...
!= "reset_one")
FAIL()
<< "expected state to be 'reset_one'";
...
if (err || !(
before_event &&leave_state
&&
enter_state &&after_event
))
FAIL()
<< "expected all callbacks to be called once";
}
...
if (!err || !
std::dynamic_pointer_cast<fsm::NoTransitionError>(err
.
value()
))
FAIL()
<< "expected 'NoTransitionError' without custom error";
...
if (!before_event)
FAIL()
<< "expected callback to be called once";
}
...
if (!err || !
std::dynamic_pointer_cast<fsm::CanceledError>(err
.
value()
))
FAIL()
<< "expected only 'CanceledError'";

if (!
std::dynamic_pointer_cast<FakeError>(std::dynamic_pointer_cast<fsm::CanceledError>(err.value())
->error_))
FAIL()
<< "expected 'CanceledError' with correct custom error";
...
if (!err || !
std::dynamic_pointer_cast<fsm::NotInTransitionError>(err
.
value()
))
FAIL()
<< "expected 'NotInTransitionError'";
}
...
if (!err || !
std::dynamic_pointer_cast<FakeError>(err
.
value()
))
FAIL()
<< "expected error to be 'FakeError'";
}
